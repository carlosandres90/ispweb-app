        ...
        <div class="form-container-CnC">
            ...
            <form class="form-CnC">
                <div class="form-group-CnC">
                    ...
                    <input class="input-CnC" type="text" id="apellidos" name="apellidos" required />
                </div>
                <div class="form-group-CnC">
                    <label class="label-CnC" for="nombres">NOMBRES:</label>
                    <input class="input-CnC" type="text" id="nombres" name="nombres" required />
                </div>
                <div class="form-group-CnC">
                    <label class="label-CnC" for="cedula">CÉDULA:</label>
                    <input class="input-CnC" type="text" id="cedula" name="cedula" required />
                </div>
                <div class="form-group-CnC">
